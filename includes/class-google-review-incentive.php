...
class Google_Review_Incentive {
    ...
    private function define_admin_hooks(): void {
        add_action( 'admin_menu', [ $this->admin_menu, 'add_plugin_menu' ] );
    ...
    private function define_public_hooks(): void {
        add_action( 'woocommerce_email_after_order_table', [ $this->email_handler, 'add_review_link' ], 10, 4 );
        add_action( 'template_redirect', [ $this->review_link_handler, 'handle_review_link_click' ] );
        add_action( 'gri_send_coupon_email', [ $this->email_handler, 'send_coupon_email' ], 10, 2 );
    }
